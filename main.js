...
var UserModel = /** @class */ (function () {
    function UserModel(name, lastname, email, password, password_confirmation, img, Biography, Facebook, Twitter, Linkedin, Paypal_client_id, Paypal_secret_key, Stripe_public_key, Stripe_secret_key, verified, role, id, updated_at, Company, Address, City, Country, Postal_Code, latitud, longitud) {
        this.name = name;
...
module.exports = "<div class=\"row\">\n  <div class=\"col-12\">\n    <div class=\"page-title-box d-flex align-items-center justify-content-between\">\n      <h4 class=\"mb-0 font-size-18\">Profile\n\n      </h4>\n      <div class=\"page-title-right\">\n        <ol class=\"breadcrumb m-0\">\n        </ol>\n\n      </div>\n\n    </div>\n\n  </div>\n\n</div>\n\n\n<div class=\"row\">\n  <div class=\"col-md-8\">\n    <div class=\"card\">\n      <div class=\"card-body\">\n        <form ngNativeValidate #f=\"ngForm\" (ngSubmit)=\"updateUser( f.value )\">\n          <div class=\"row\">\n            <div class=\"col-md-5 pr-1\">\n              <div class=\"form-group\">\n                <label>Company </label>\n                <input type=\"text\" class=\"form-control\" [ngModel]=\"User.Company\" name=\"Company\" placeholder=\"Company\" >\n              </div>\n            </div>\n            \n            <div class=\"col-md-7 pl-1\">\n              <div class=\"form-group\">\n                <label >Email address (disabled)</label>\n                <input type=\"email\"  [ngModel]=\"User.email\" disabled=\"\" name=\"email\" class=\"form-control\" placeholder=\"Email\">\n\n              </div>\n            </div>\n          </div>\n\n          <div class=\"row\">\n            <div class=\"col-md-6 pr-1\">\n              <div class=\"form-group\">\n                <label>First Name</label>\n                <input type=\"text\"  [ngModel]=\"User.name\" name=\"name\" class=\"form-control\" placeholder=\"name\">\n              </div>\n            </div>\n            <div class=\"col-md-6 pl-1\">\n              <div class=\"form-group\">\n                <label>Last Name</label>\n                <input type=\"text\" [ngModel]=\"User.lastname\" name=\"lastname\" class=\"form-control\" placeholder=\"Last Name\">\n              </div>\n            </div>\n          </div>\n\n          <div class=\"row\">\n            <div class=\"col-md-12\">\n              <div class=\"form-group\">\n                <label>Address</label>\n                <input type=\"text\" [ngModel]=\"User.Address\" name=\"Address\"  class=\"form-control\" placeholder=\"Home Address\" value=\"\">\n              </div>\n            </div>\n          </div>\n\n          <div class=\"row\">\n            <div class=\"col-md-4 pr-1\">\n              <div class=\"form-group\">\n                <label>City</label>\n                <input type=\"text\" [ngModel]=\"User.City\" name=\"City\" class=\"form-control\" placeholder=\"City\" value=\"\">\n              </div>\n            </div>\n            <div class=\"col-md-4 px-1\">\n              <div class=\"form-group\">\n                <label>Country</label>\n                <input type=\"text\" [ngModel]=\"User.Country\" name=\"Country\" class=\"form-control\" placeholder=\"Country\" value=\"\">\n              </div>\n            </div>\n            <div class=\"col-md-4 pl-1\">\n              <div class=\"form-group\">\n                <label>Postal Code</label>\n                <input type=\"number\" [ngModel]=\"User.Postal_Code\" name=\"Postal_Code\" class=\"form-control\" placeholder=\"\">\n              </div>\n            </div>\n          </div>\n\n          <div class=\"row\">\n            <div class=\"col-md-12\">\n              <div class=\"form-group\">\n                <label>About Me</label>\n                <textarea rows=\"4\" cols=\"80\"  [ngModel]=\"User.Biography\" name=\"Biography\" class=\"form-control\" placeholder=\"Here can be your description\"\n                  value=\"\"></textarea>\n              </div>\n            </div>\n          </div>\n          <div class=\"row\">\n            <div class=\"col-md-12\">\n              <div class=\"form-group\">\n                <input type=\"submit\" class=\"btn btn-success\">\n              </div>\n            </div>\n          </div>\n        </form>\n      </div>\n    </div>\n  </div>\n  <div class=\"col-md-4\">\n    <div class=\"card card-user\">\n      <div class=\"image\">\n        <img class=\"img\" src=\"assets/images/bg5.jpg\" alt=\"...\">\n      </div>\n      <div class=\"card-body\">\n        <div class=\"author\">\n          <a>\n            <img (click)=\"_modalService.modtrarModal('users', _userService.UserData.id)\" class=\"avatar border-gray img\"\n              [src]=\"_userService.UserData.img | imagen\">\n            <h5 class=\"title\">{{_userService.UserData.name}} {{_userService.UserData.lastname}}</h5>\n          </a>\n          <p class=\"description\">\n            UI/UX Designer\n          </p>\n        </div>\n        <p class=\"description text-center\">\n          {{_userService.UserData.Biography}}\n        </p>\n      </div>\n      <hr>\n      <div class=\"button-container\">\n        <button href=\"#\" class=\"btn btn-neutral btn-icon btn-round btn-lg\">\n          <i class=\"fab fa-facebook-f\"></i>\n        </button>\n        <button href=\"#\" class=\"btn btn-neutral btn-icon btn-round btn-lg\">\n          <i class=\"fab fa-twitter\"></i>\n        </button>\n        <button href=\"#\" class=\"btn btn-neutral btn-icon btn-round btn-lg\">\n          <i class=\"fab fa-google-plus-g\"></i>\n        </button>\n      </div>\n    </div>\n  </div>\n"
...
/*!******************************************!*\
  !*** ./src/app/service/index.service.ts ***!
  \******************************************/
/*! exports provided: LockScreenService, CoursesService, EnrolmentService, CategoryService, SubCategoryService, ModalUploadService, UploadService, MenuService, UsersService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _LockScreen_lock_screen_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./LockScreen/lock-screen.service */ "./src/app/service/LockScreen/lock-screen.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LockScreenService", function() { return _LockScreen_lock_screen_service__WEBPACK_IMPORTED_MODULE_0__["LockScreenService"]; });

/* harmony import */ var _courses_courses_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./courses/courses.service */ "./src/app/service/courses/courses.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CoursesService", function() { return _courses_courses_service__WEBPACK_IMPORTED_MODULE_1__["CoursesService"]; });

/* harmony import */ var _enrolment_enrolment_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./enrolment/enrolment.service */ "./src/app/service/enrolment/enrolment.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EnrolmentService", function() { return _enrolment_enrolment_service__WEBPACK_IMPORTED_MODULE_2__["EnrolmentService"]; });

/* harmony import */ var _Category_category_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Category/category.service */ "./src/app/service/Category/category.service.ts");
...
/* harmony import */ var _SubCategory_sub_category_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SubCategory/sub-category.service */ "./src/app/service/SubCategory/sub-category.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SubCategoryService", function() { return _SubCategory_sub_category_service__WEBPACK_IMPORTED_MODULE_4__["SubCategoryService"]; });

/* harmony import */ var _modal_upload_modal_upload_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modal-upload/modal-upload.service */ "./src/app/service/modal-upload/modal-upload.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ModalUploadService", function() { return _modal_upload_modal_upload_service__WEBPACK_IMPORTED_MODULE_5__["ModalUploadService"]; });

/* harmony import */ var _upload_upload_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./upload/upload.service */ "./src/app/service/upload/upload.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UploadService", function() { return _upload_upload_service__WEBPACK_IMPORTED_MODULE_6__["UploadService"]; });

/* harmony import */ var _menu_menu_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./menu/menu.service */ "./src/app/service/menu/menu.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MenuService", function() { return _menu_menu_service__WEBPACK_IMPORTED_MODULE_7__["MenuService"]; });

/* harmony import */ var _users_users_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./users/users.service */ "./src/app/service/users/users.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UsersService", function() { return _users_users_service__WEBPACK_IMPORTED_MODULE_8__["UsersService"]; });
...
var UsersService = /** @class */ (function () {
    function UsersService(http, router, alert) {
        this.http = http;
        this.router = router;
        this.alert = alert;
        this.token = '';
...
module.exports = "<footer class=\"d-print-none\">\n  <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-5 footer-areatop\">\n        <p>Top companies choose SUCCESSU to build in-demand career skills.</p>\n      </div>\n      <div class=\"col-7 footer-areatop\">\n        <ul class=\"nav justify-content-md-end footer-menu\">\n          <li class=\"nav-item\">\n            <a href=\"\"><img src=\"assets/logos/1.png\" alt=\"\" class=\"d-inline-block \" width=\"100\"></a>\n          </li>\n          <li class=\"nav-item\">\n            <a href=\"\"><img src=\"assets/logos/2.png\" alt=\"\" class=\"d-inline-block\" width=\"80\"></a>\n          </li>\n          <li class=\"nav-item\">\n            <a href=\"\"><img src=\"assets/logos/3.png\" alt=\"\" class=\"d-inline-block\" width=\"100\"></a>\n          </li>\n          <li class=\"nav-item\">\n            <a href=\"\"><img src=\"assets/logos/4.png\" alt=\"\" class=\"d-inline-block\" width=\"100\"></a>\n          </li>\n          <li class=\"nav-item\">\n            <a href=\"\"><img src=\"assets/logos/5.png\" alt=\"\" class=\"d-inline-block\" width=\"100\"></a>\n          </li>\n        </ul>\n      </div>\n      <div class=\"col-4 footer-areatop\">\n        <div class=\"copyright-text\">\n          <a href=\"\"><img src=\"assets/logos/logocolor.png\" alt=\"\" class=\"d-inline-block\" width=\"200\"></a>\n          <a href=\"http://creativeitem.com/\" target=\"_blank\"></a>\n        </div>\n      </div>\n\n\n\n      <div class=\"col-4 footer-areatop\">\n        <ul class=\"nav justify-content-md-end footer-menu\">\n          <li class=\"myq\">\n            Copyright 2020 SuccessU All Rights Reserved.\n          </li>\n\n        </ul>\n      </div>\n      <div class=\"col-4 footer-areatop\">\n        <ul class=\"nav justify-content-md-end footer-menu\">\n          <li class=\"myq\">\n            <a href=\"\">Privacy policy</a>\n          </li>\n          <li class=\"myq\">\n            <a href=\"\">Terms and condition</a>\n          </li>\n\n        </ul>\n      </div>\n    </div>\n  </div>\n</footer>\n"
