...
var MenuService = /** @class */ (function () {
    function MenuService(router, http) {
        ...
        this.menu1 = [
            ...
            { name: 'Messager', iconclass: 'ri-home-7-fill', router: 'messages_' },
        ];
    }
