...
var CourseAddComponent = (function () {
    ...
    CourseAddComponent.prototype.newAddR = function () { this.arrayRequi.insert(0, this.addRequirements()); };
    ;
    CourseAddComponent.prototype.newArrayOutcomes = function () { this.arrayOutcomes.insert(0, this.addOutcomes()); };
    ;
    CourseAddComponent.prototype.removeR = function (index) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component_modal_modal_upload_service__ = __webpack_require__("../../../../../src/app/component/modal/modal-upload.service.ts");
...
var CrudUsersComponent = (function () {
    ...
    CrudUsersComponent.prototype.funtionDesde = function (value) {
    ...
    CrudUsersComponent.prototype.updateFilterStudemt = function (event, type) {
        var val = event.toLowerCase();
        if (type == 'name') {
            this.arrayFilter.name = val;
    ...
    CrudUsersComponent.prototype.updateFilterTeacher = function (event, type) {
        var val = event.toLowerCase();
        if (type == 'name') {
            this.arrayFilter.name = val;
        }
    ...
    CrudUsersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_service_index__["f" /* MenuService */],
            __WEBPACK_IMPORTED_MODULE_1__services_service_index__["j" /* UserService */],
            __WEBPACK_IMPORTED_MODULE_3__component_modal_modal_upload_service__["a" /* ModalUploadService */],
...
module.exports = "<div class=\"row\">\n  <div class=\"card\">\n    <div class=\"card-body\">\n      <div class=\"row\">\n        <div class=\"col-xl-4\">\n          <div class=\"card\">\n            <div class=\"card-body\">\n\t\t\t\t<div class=\"form-group row\">\n\t\t\t\t<div class=\"col-xl-12\">\n                          <div class=\"wrapper-image-preview float-left\" style=\"margin-left: -6px\">\n                             <div class=\"box\" style=\"width: 250px;\">\n                                <!-- <div class=\"js--image-preview stylemyImage\"></div> -->\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<img [src]=\"_userService.UserData.img | imagen\" class=\"js--image-preview\" alt=\"\">\n                                <div class=\"\">\n                                   <a for=\"course_thumbnail\" (click)=\"_modalService.modtrarModal('users', _userService.UserData.id)\" class=\"btn\" style=\"color: black !important;\"> <i class=\"ri-camera-line\"></i> Course thumbnail <br> <small>(600 X 550)</small> </a>\n                                   <input autocomplete=\"off\"  style=\"color: black !important;\" type=\"file\" class=\"\" name=\"course_thumbnail\" >\n                                </div>\n                             </div>\n                       </div>\n                    </div>\n\n                 </div>\n              <div class=\"col-12\" style=\"background: #8b0013;\">\n                <br>\n                <h3 class=\"blanca\">\t\n\t\t\t\t\tUI/UX Designer</h3>\n                <h5 class=\"grea\">osedhelu</h5>\n                <div class=\"border-bottom\"></div>\n\n                <a class=\"grea\"><i class=\"fas fa-phone blanca\"></i>&nbsp;&nbsp;383764853</a><br>\n                <a class=\"grea\"><i class=\"fas fa-envelope blanca\"></i>&nbsp;&nbsp;{{_userService.UserData.email}}</a><br>\n                <a class=\"grea\"><i class=\"far fa-id-card blanca\"></i>&nbsp;&nbsp;https://asjdjkb</a><br>\n                <div class=\"border-bottom\"></div>\n                <div class=\"col_\">\n\t\t\t\t\t<a href=\"\"><i class=\"fab fa-facebook fa-2x  blanca\"></i></a>\n\t\t\t\t\t<a href=\"\"><i class=\"fab fa-linkedin fa-2x blanca\"></i></a>\n\t\t\t\t\t<a href=\"\"><i class=\"fab fa-twitter fa-2x blanca\"></i></a>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n\n        <div class=\"col-xl-8\">\n          <div class=\"mt-4 mt-xl-3\">\n            <h4 *ngIf=\"_userService.UserData.role == 'teacher'\" class=\"mt-1 mb-3\">Instructor Information</h4>\n\n            <p class=\"text-muted float-left mr-3\">\n              <span class=\"bx bx-star text-warning\"></span>\n              <span class=\"bx bx-star text-warning\"></span>\n              <span class=\"bx bx-star text-warning\"></span>\n              <span class=\"bx bx-star text-warning\"></span>\n              <span class=\"bx bx-star\"></span>\n            </p>\n            <p class=\"text-muted mb-4\">( 152 Customers Review )</p>\n\n            <h6 class=\"text-success text-uppercase\">20 % Off</h6>\n            <h5 class=\"mb-4\">Price : <span class=\"text-muted mr-2\"><del>$240 USD</del></span> <b>$225 USD</b></h5>\n            <p class=\"text-muted mb-4\">To achieve this, it would be necessary to have uniform grammar pronunciation and\n              more common words If several languages coalesce</p>\n            <div class=\"row mb-3\">\n              <div class=\"col-md-6\">\n                <div>\n                  <p class=\"text-muted\"><i class=\"bx bx-unlink font-size-16 align-middle text-primary mr-1\"></i>\n                    Wireless</p>\n                  <p class=\"text-muted\"><i class=\"bx bx-shape-triangle font-size-16 align-middle text-primary mr-1\"></i>\n                    Wireless Range : 10m</p>\n                  <p class=\"text-muted\"><i class=\"bx bx-battery font-size-16 align-middle text-primary mr-1\"></i>\n                    Battery life : 6hrs</p>\n                </div>\n              </div>\n              <div class=\"col-md-6\">\n                <div>\n                  <p class=\"text-muted\"><i class=\"bx bx-user-voice font-size-16 align-middle text-primary mr-1\"></i>\n                    Bass</p>\n                  <p class=\"text-muted\"><i class=\"bx bx-cog font-size-16 align-middle text-primary mr-1\"></i> Warranty :\n                    1 Year</p>\n                </div>\n              </div>\n            </div>\n\n          \n          </div>\n        </div>\n      </div>\n      <!-- end row -->\n\n    </div>\n  </div>\n  <!-- end card -->\n</div>\n"
...
var UserService = (function () {
    ...
    UserService.prototype.allStudents = function (desde, filter) {
        if (desde === void 0) { desde = 1; }
        var url = __WEBPACK_IMPORTED_MODULE_2__config_config__["a" /* URL_SERVICES */] + "/Students?page=" + desde;
        return this.http.get(url, { params: filter }).map(function (resp) {
            return resp.data;
        });
    };
    UserService.prototype.allTeacher = function (desde, filter) {
        if (desde === void 0) { desde = 1; }
        var url = __WEBPACK_IMPORTED_MODULE_2__config_config__["a" /* URL_SERVICES */] + "/instructor?page=" + desde;
        return this.http.get(url, { params: filter }).map(function (resp) {
            return resp.data;
        });
    };
    ...
    UserService.prototype.showAllStudent = function () {
        var _this = this;
        var url = __WEBPACK_IMPORTED_MODULE_2__config_config__["a" /* URL_SERVICES */] + "/showStudent";
        return this.http.get(url).catch(function (err) {
