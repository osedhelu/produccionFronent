...
var ViewCoursesComponent = /** @class */ (function () {
    function ViewCoursesComponent(router, _OneCourse, activateRouter, _menu) {
        var _this = this;
        this.router = router;
