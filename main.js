...
var CoursesComponent = /** @class */ (function () {
    ...
    CoursesComponent.prototype.nuevooculto = function (event) {
        console.log(event);
        /*
        this.oculFilter += event;
        const tipo = (this.oculFilter % 2) ? false : true;
        this.allFilter = tipo;
 */
    };
